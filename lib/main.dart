...
void main() {
  runApp(
    MaterialApp(
      // Tira o tag de debug da aplicação no browser
...
class _MainAppState extends State<MainApp> {
  ...
  String? _erroTexto;
  final List<String> _opcoes = []; // Lista vazia de texto

  final Random _random = Random();

  static const Color _roxo = Color(0xFF6C63FF);
  static const Color _roxoClaro = Color(0xFFF0EFFF);
  static const Color _roxoMedia = Color(0xFFD9D6FF);
  static const Color _cinza = Color(0xFF888888);
  static const Color _vermelho = Color(0xFFE53935);
  ...
  void _sortear() {
    ...
    // SNACKBAR
    // Alternativa mais leve e harmônica para aquele AlertDialog
    void _mostrarErro(String mensagem) {
      ScaffoldMessenger.of(context).showSnackBar(
        ...
        behavior: SnackBarBehavior.floating, // Flutuar acima do coteúdo
    ...
    // Criar método _adicionarOpcao sem parametro 
    void _adicionarOpcao() {
      final texto = _opcaoController.text.trim(); // trim remove espaços
      if (texto.isEmpty) {
    ...
    // Criar metodo _removerOpcao onde recebe um parametro inteiro nome index 
